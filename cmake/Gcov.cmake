...
# )
#
# This function is a helper function to integrate coverage report with unit testing,
...
#
# ``CUSTOM_TARGET``
#       This creates a custom target instead of running after test, useful when you need to invoke gcovr multiple times
#
# ``EXTRA_OPTIONS``
...
function (add_gcov_report)
  ...
  if (_TARGET)
    add_custom_command(TARGET ${_TARGET} POST_BUILD COMMAND "$<$<CONFIG:Coverage>:${GCOVR};.;${GCOV_CMD}>" WORKING_DIRECTORY ${working_dir}
